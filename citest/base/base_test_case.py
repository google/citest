...
class BaseTestCase(unittest.TestCase):
  ...
  This class is intended to be used in conjunction with the TestRunner, though not
  strictly required. The test runner will call the initArgumentParser method introduced
  by this base class to allow tests to add custom bindings.
  """
